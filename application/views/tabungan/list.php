                        ...
                        <table class="table table-hover" id="list">
                            <thead>
                                <tr>
                                    ...
                                    <th><i class="fa fa-home "></i>Tabungan Masuk</th>
                                    <th><i class="fa fa-home "></i>Tanggal Masuk</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                            ...
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="tabungan_masuk" value="" type="text" placeholder="Enter Tabungan Masuk" required="" name="tabungan_masuk" class="form-control ">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="tanggal_masuk">Tanggal Tabungan Masuk <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="tanggal_masuk" value="" type="date" name="tanggal_masuk" class="form-control ">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- End Tambah Data -->
<?php include APPPATH . 'views/template/script/script-tab.php' ?>